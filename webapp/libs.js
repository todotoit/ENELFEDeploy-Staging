...
TERMINALIA.FEScene = function FEScene(container, CustomShaders) {
    ...
    function initScene() {
        ...
        //initOrthoCamera();
        addLights();
        addCubeMap('../libs/terminalia/assets/textures/cubemaps/parliament/', '.jpg');
        addAssets();
        addPins();
        ///addOrthoAssets();
        addInfoFlags();
    ...
    function addFECar() {
        ...
        //Body
        var carBodyMat = self.TerminUtils.createTextureReflectiveMaterial('../libs/terminalia/assets/textures/new_car/body_allianz.jpg', self.reflectionMap, .5);
        carBodyMat.side = THREE.DoubleSide;
        var carBody = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/body_high.obj', carBodyMat);
        carGroup.add(carBody);

        //Body Bottom
        var carBodyBottomMat = new THREE.MeshLambertMaterial({color: 0x000000});
        var carBodyBottom = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/body_bottom.obj', carBodyBottomMat);
        carGroup.add(carBodyBottom);

        //Wheels
        var carWheelsMat = new THREE.MeshLambertMaterial( { color: 0xcbcfd6, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: 1.0} );
        var carWheels = self.TerminUtils.loadObjModel("CarWheels", '../libs/terminalia/assets/models/obj/new_car/wheels.obj', carWheelsMat);
        carGroup.add(carWheels);

        //Back Wheels
        var carBackWheelsMat = new THREE.MeshLambertMaterial( { color: 0x000000, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: .2} );
        var carBackWheels = self.TerminUtils.loadObjModel("CarWheels", '../libs/terminalia/assets/models/obj/new_car/BackWheels.obj', carBackWheelsMat);
        carGroup.add(carBackWheels);

        //Tires
        var carTiresTexture = self.TerminUtils.createTexture('../libs/terminalia/assets/textures/new_car/Tires2.jpg');
        var carTiresMat = new THREE.MeshPhongMaterial({map: carTiresTexture, bump: carTiresTexture, bumpScale  :  0.45});
        var carTires = self.TerminUtils.loadObjModel("CarWheels", '../libs/terminalia/assets/models/obj/new_car/tires.obj', carTiresMat);
        carGroup.add(carTires);

        //Brakes
        var carBrakesMat = self.TerminUtils.createTextureReflectiveMaterial('../libs/terminalia/assets/textures/new_car/Brake.png', self.reflectionMap, .5);
        carBrakesMat.side = THREE.DoubleSide;
        var carBrakes = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/brakes.obj', carBrakesMat);
        carGroup.add(carBrakes);

        //Calisper
        //var carCalisperMat = self.TerminUtils.createTextureReflectiveMaterial('../libs/terminalia/assets/textures/new_car/Calisper.png', self.reflectionMap, .5);
        var carCalisperMat = new THREE.MeshLambertMaterial( { color: 0xcbcfd6, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: 0.5} );
        carCalisperMat.side = THREE.DoubleSide;
        var carCalisper = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/calisper.obj', carCalisperMat);
        carGroup.add(carCalisper);

        //Suspensions
        var carSuspensionsMat = new THREE.MeshLambertMaterial( { color: 0xcbcfd6, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: 1.0} );
        var carSuspensions = self.TerminUtils.loadObjModel("CarWheels", '../libs/terminalia/assets/models/obj/new_car/suspensions.obj', carSuspensionsMat);
        carGroup.add(carSuspensions);

        //Engine
        var carEngineMat = new THREE.MeshLambertMaterial( { color: 0xcbcfd6, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: 1.0} );
        var carEngine = self.TerminUtils.loadObjModel("CarWheels", '../libs/terminalia/assets/models/obj/new_car/Engine.obj', carWheelsMat);
        carGroup.add(carEngine);

        //Engine Diffusor
        var carEngineDiffMat = new THREE.MeshLambertMaterial({color: 0x3e4247});
        carEngineDiffMat.side = THREE.DoubleSide;
        var carEngineDiff = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/Engine_Diffusor.obj', carEngineDiffMat);
        carGroup.add(carEngineDiff);

        //Transmissions
        var carTransmissionMat = new THREE.MeshLambertMaterial( { color: 0xcbcfd6, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: 1.0} );
        carTransmissionMat.side = THREE.DoubleSide;
        var carTransmission = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/Transmission.obj', carTransmissionMat);
        carGroup.add(carTransmission);

        //Cockpit
        var carCockPitMat = new THREE.MeshLambertMaterial({color: 0x000000});
        var carCockPit = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/Cockpit.obj', carCockPitMat);
        carGroup.add(carCockPit);

        //Cockpit UP
        var carCockPitUpMat = new THREE.MeshLambertMaterial({color: 0x444547});
        var carCockPitUp = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/CockpitUp.obj', carCockPitUpMat);
        carGroup.add(carCockPitUp);

        //Seat
        var carSeatpMat = new THREE.MeshLambertMaterial({color: 0x444547});
        var carSeat = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/Seat.obj', carSeatpMat);
        carGroup.add(carSeat);

        //Belts
        var carBeltsMat = new THREE.MeshLambertMaterial({color: 0x272728});
        var carBelts = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/Belts.obj', carBeltsMat);
        carGroup.add(carBelts);

        //Belts
        var carBeltsMetalMat = new THREE.MeshLambertMaterial( { color: 0xcbcfd6, envMap: self.reflectionMap, combine: THREE.MixOperation, reflectivity: 1.0} );
        var carBeltsMetal = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/Belts_Metal.obj', carBeltsMetalMat);
        carGroup.add(carBeltsMetal);

        //Rec Camera
        var carRecCameraMat = new THREE.MeshLambertMaterial({color: 0x4445473});
        var carRecCamera = self.TerminUtils.loadObjModel("CarBody", '../libs/terminalia/assets/models/obj/new_car/RecCamera.obj', carRecCameraMat);
        carGroup.add(carRecCamera);
    ...
    function addCircuit(size, offset) {
        ...
        var circuit = self.TerminUtils.loadObjModel('Circuit', '../libs/terminalia/assets/models/obj/circuit.obj', toonMaterial);
